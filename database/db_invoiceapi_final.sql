...
INSERT INTO `tbl_invoice` (`no_invoice`, `tanggal_dibuat`, `mata_uang`, `kode_bank`, `no_suratjalan`, `kode_manager`, `tgl_jatuhtempo`, `no_staff`) VALUES
('FT/12/02/2021', '2021-02-12 13:10:35', 'IDR', 'BCA', 'SJ/12022021/PO2', 'MGR192301', '2021-02-13 14:00:00', '2801923813'),
('FT/30/01/2021', '2021-01-30 02:46:14', 'IDR', 'BCA', 'SJ/30012021/PO1', 'MGR192301', '2021-02-28 15:00:00', '8912371237');
...
INSERT INTO `tbl_transaksi` (`id_transaksi`, `no_invoice`, `no_po`, `kode_partner`, `kode_produk`, `dateadded`, `jml_qty`) VALUES
(1, 'FT/30/01/2021', 'PO-1/01/2021', 'CM0123', 'B7623984', '2021-02-10 03:47:12', 10),
(2, 'FT/30/01/2021', 'PO-1/01/2021', 'CM0123', 'B7623985', '2021-02-10 03:47:14', 26),
(3, 'FT/30/01/2021', 'PO-1/01/2021', 'CM0123', 'B7623986', '2021-02-10 03:47:19', 25),
(4, 'FT/30/01/2021', 'PO-1/01/2021', 'CM0123', 'B7623987', '2021-02-10 03:47:23', 25),
(5, 'FT/30/01/2021', 'PO-1/01/2021', 'CM0123', 'B7623988', '2021-02-10 03:47:25', 8),
(6, 'FT/30/01/2021', 'PO-1/01/2021', 'CM0123', 'B7623989', '2021-02-10 03:47:33', 12),
(7, 'FT/30/01/2021', 'PO-1/01/2021', 'CM0123', 'B7623990', '2021-02-10 03:47:35', 10),
(8, 'FT/30/01/2021', 'PO-1/01/2021', 'CM0123', 'B7623991', '2021-02-10 03:47:37', 5),
(9, 'FT/12/02/2021', 'PO-2/02/2021', 'CM1239', 'B7623990', '2021-02-10 12:43:37', 15),
(10, 'FT/12/02/2021', 'PO-2/02/2021', 'CM1239', 'B7623991', '2021-02-10 12:43:39', 12);
...
ALTER TABLE `tbl_invoice`
  ADD PRIMARY KEY (`no_invoice`,`kode_bank`,`no_suratjalan`,`kode_manager`,`no_staff`) USING BTREE,
  ...
  ADD KEY `fk_staff2invoice` (`no_staff`);
...
ALTER TABLE `tbl_transaksi`
  ADD PRIMARY KEY (`id_transaksi`,`no_invoice`,`no_po`,`kode_partner`,`kode_produk`) USING BTREE,
...
ALTER TABLE `tbl_invoice`
  ...
  ADD CONSTRAINT `fk_staff2invoice` FOREIGN KEY (`no_staff`) REFERENCES `tbl_staff` (`no_staff`),
